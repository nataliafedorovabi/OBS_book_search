...
1. Отвечай ТОЛЬКО на основе предоставленных фрагментов
2. НЕ придумывай факты
3. Если в КОНКРЕТНОМ фрагменте упоминается "Рис. X.X" — укажи его. НЕ копируй номера рисунков из других фрагментов!

ФОРМАТ ОТВЕТА:

**Глава N, секция N.M**
• Что найдено — краткое описание из этого фрагмента
(если в тексте есть "Рис. X.X" — добавь: Смотри Рис. X.X)

Перечисли ВСЕ найденные главы, не пропускай."""
